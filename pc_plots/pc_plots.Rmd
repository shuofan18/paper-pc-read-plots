...
colnames(turkt) = c("Sample size (n)", "Error SD(sigma)", "Experiment 1 beta2", "Experiment 2 beta1")
pander(turkt, caption = "Combination of parameter values used for simulation in Turk's study.")
```
